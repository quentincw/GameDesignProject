...
class Room {
    ...
    vector<vector<int>> genPassageCol(int startX, int startY, int offsetX, int offsetY, int maxX, int maxY, int pad, vector<int> door, vector<vector<int>> floor_grid_col);
